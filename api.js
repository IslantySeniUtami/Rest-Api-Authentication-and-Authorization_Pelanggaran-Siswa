...
const crypt = new Cryptr("12345") // secret key, boleh diganti kok

var password_cek = 'islanty123'
...
app.listen(8000, () => {
    console.log("Authentication dan Authorization Pelanggaran Siswa run on port 8000")
})